    ...
    <Tab.Container id="left-tabs-example" defaultActiveKey="first">
      ...
      <Row>
        <Tab.Content>
          ...
          <Tab.Pane eventKey="second"><SignUpPane doSignUp={props.doSignUp} message={props.message} setMessage={props.setMessage} /></Tab.Pane>
        </Tab.Content>
      </Row>
    </Tab.Container>
  );
...
function SignUpPane(props) {
  ...
  function handleSubmit(event) {
    ...
    if (valid) {
      props.doSignUp(email, password, firstName, lastName, phone);
    }
